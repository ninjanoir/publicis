	...
	return (
		<div className='w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden cursor-pointer'>
			<div
				...
				<button className='p-2 rounded-full bg-blue-600 text-white mx-5 -mb-4 hover:bg-blue-500 focus:outline-none focus:bg-blue-500' onClick={ ()=> handleAddCart(product)}>
					<svg
						className='h-5 w-5'
						fill='none'
						strokeLinecap='round'
